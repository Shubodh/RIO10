...
if __name__ == '__main__':
    ...
    for room_id in room_ids:
        print("\n")
        print(room_id)
        print("python plot_scene0X.py --data_path ../data/ --type 2 --config ../config_graphVPR_sampling10_scene0" + room_id + ".json --scene_id 0" + room_id + " --scene_type " + scene_type + " --dttime " + dttime)
        if not debug_print:
            os.system("python plot_scene0X.py --data_path ../data/ --type 2 --config ../config_graphVPR_sampling10_scene0" + room_id + ".json --scene_id 0" + room_id + " --scene_type " + scene_type + " --dttime " + dttime)